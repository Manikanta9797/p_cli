...
def call(){
  ...
  sh "az pipelines create --name ${pipelinename} --repository repo2 --branch master --repository-type tfsgit --yml-path azure-pipelines.yml --org https://dev.azure.com/${organization} --project Demo1"
